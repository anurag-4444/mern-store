...
export const addProductToWishlist = createAsyncThunk(
    ...
    async (args) => {
        ...
        const response = await axios.post(`${window.location.origin}/api/v1/me/add/product/wishlist`, { ...args }, {
            headers: {
...
export const getProductFromWishlist = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`${window.location.origin}/api/v1/me/product/wishlist`)
        return response.data
    }
);
...
export const deleteProductFromWishlist = createAsyncThunk(
    ...
    async (args) => {
        // console.log(args);
        const response = await axios.delete(`${window.location.origin}/api/v1/me/delete/product/wishlist`, { data: args }, {
            headers: {
                'Content-Type': 'application/json'
            }
        })
