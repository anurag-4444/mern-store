...
export const adminFetchAllProducts = createAsyncThunk(
  ...
  async (args) => {
    ...
    let link = `${window.location.origin}/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${minPrice}&price[lte]=${maxPrice}&ratings[gte]=${ratings}`
...
export const fetchProductDetail = createAsyncThunk(
  'product/fetchDetail',
  async (id) => {
    const response = await axios.get(`${window.location.origin}/api/v1/product/${id}`);
    return response.data;
  }
);
...
export const adminCreateProduct = createAsyncThunk(
  ...
  async (formData) => {
    ...
    const response = await axios.post(`${window.location.origin}/api/v1/admin/product/new`, formData, {
      headers: {
...
export const adminUpdateProduct = createAsyncThunk(
  ...
  async ({ formData, id }) => {
    // console.log(formData);
    const response = await axios.put(`${window.location.origin}/api/v1/admin/product/${id}`, formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    })
...
export const adminDeleteProduct = createAsyncThunk(
  ...
  async (id) => {
    ...
    const response = await axios.delete(`${window.location.origin}/api/v1/admin/product/${id}`)
    return response.data
  }
);
...
export const adminFetchAllOrders = createAsyncThunk(
  ...
  async () => {
    let link = `${window.location.origin}/api/v1/admin/orders`
    const response = await axios.get(link);
    return response.data;
  }
);
...
export const adminDeleteOrder = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.delete(`${window.location.origin}/api/v1/admin/order/${id}`)
    return response.data
  }
);
...
export const adminGetOrder = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(`${window.location.origin}/api/v1/order/${id}`)
    return response.data
  }
);
...
export const adminUpdateOrder = createAsyncThunk(
  ...
  async ({ id, status }) => {
    // console.log(formData);
    const response = await axios.put(`${window.location.origin}/api/v1/admin/order/${id}`, { status }, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    })
...
export const adminFetchAllUsers = createAsyncThunk(
  ...
  async () => {
    let link = `${window.location.origin}/api/v1/admin/users`
    const response = await axios.get(link);
    return response.data;
  }
);
...
export const adminUpdateUser = createAsyncThunk(
  ...
  async ({ id, role }) => {
    const response = await axios.put(`${window.location.origin}/api/v1/admin/user/${id}`, { role }, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    })
...
export const adminDeleteUser = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.delete(`${window.location.origin}/api/v1/admin/user/${id}`)
    return response.data;
  }
);
...
export const adminFetchAllReviews = createAsyncThunk(
  ...
  async (id) => {
    let link = `${window.location.origin}/api/v1/reviews?id=${id}`
    const response = await axios.get(link);
    return response.data;
  }
)
...
export const adminDeleteReview = createAsyncThunk(
  ...
  async ({ reviewId, productId }) => {
    let link = `${window.location.origin}/api/v1/reviews?id=${reviewId}&productId=${productId}`
