...
export const fetchAllProducts = createAsyncThunk(
  ...
  async (args) => {
    ...
    if (category) link = `${window.location.origin}/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${minPrice}&price[lte]=${maxPrice}&category=${category}&ratings[gte]=${ratings}`
