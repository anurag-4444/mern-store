...
export const getProductCart = createAsyncThunk(
    'user/getFromCart',
    async () => {
        const response = await axios.get(`${window.location.origin}/api/v1/me/product/cart`)
...
export const addNewOrder = createAsyncThunk(
    'user/addOrder',
    async (args) => {
        const response = await axios.post(`${window.location.origin}/api/v1/order/new`, { ...args }, {
            headers: {
...
export const getOrder = createAsyncThunk(
    'user/getOrder',
    async () => {
        const response = await axios.get(`${window.location.origin}/api/v1/orders/me`)
        return response.data
    }
);
